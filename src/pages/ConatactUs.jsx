...
const ContactUs = () => {
  ...
  return (
    <form onSubmit={submit} className="flex flex-col items-center text-sm">
      <Link
        to={"/"}
        className="flex justify-center items-center text-[#F97316] gap-3 "
      >
        <svg
          stroke="#F97316"
          fill="#F97316"
        ...
        <p className="text-lg font-medium pb-2 mt-2">DevTace</p>
      </Link>
