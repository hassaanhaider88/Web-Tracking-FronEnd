...
import { FaBox, FaHome, FaChevronDown, FaChevronRight } from "react-icons/fa";
  ...
  const deliveries = [
    {
      ...
      shipper: "Zalando",
      carrier: "DHL",
      parcelNumber: "PR1239876523456789dfghj",
      status: "IN DELIVERY",
    ...
    },
    {
      ...
      shipper: "Wayfair",
      carrier: "UPS",
      parcelNumber: "Z1 123 312384 8444",
      status: "DELIVERED",
      statusColor: "bg-green-100 text-green-600",
    },
    {
      ...
      shipper: "Amazon",
      carrier: "Amazon",
      parcelNumber: "PR123987612313Z5PR1",
      status: "DELIVERED",
      statusColor: "bg-green-100 text-green-600",
    },
  ];
                        ...
                        {AllProjects.map((project, index) => (
                          ...
                          >
                            ...
                            <td className="py-4 px-4">
                              <FiDelete
                                onClick={() => hanldeSiteDeletion(project._id)}
                                size={27}
